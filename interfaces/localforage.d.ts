...
declare module "localforage" {
    ...
    */
    ...
    function driver(): LocalForageDriver;
    /**
    * Force usage of a particular driver or drivers, if available.
    * @param {string} driver
    */
    function setDriver(driver: string | string[]): Promise<void>;
    function setDriver(driver: string | string[], callback: () => void, errorCallback: (error: any) => void): void;
    function defineDriver(driver: LocalForageDriver): Promise<void>;
    function defineDriver(driver: LocalForageDriver, callback: () => void, errorCallback: (error: any) => void): void;
    ...
    function setItem<T>(key: string, value: T, callback: (err: any, value: T) => void): void;
    ...
    function key(keyIndex: number): Promise<string>;
    ...
    function iterate(iteratee: (value: any, key: string, iterationNumber: number) => any): Promise<any>;
    function iterate(iteratee: (value: any, key: string, iterationNumber: number) => any,
            callback: (err: any, result: any) => void): void;
}
